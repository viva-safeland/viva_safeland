...
class HMI:
    ...
    def __init__(self, dead_zone: float = 0.1) -> None:
        ...
        self.fk: float = 0.0            # Thrust
        self.command: str | None = None # Command: "takeoff", "land", "reset", or None
    ...
    def __call__(self) -> Tuple[np.ndarray, str | None, bool]:
        ...
        return actions, self.command, not self.active
