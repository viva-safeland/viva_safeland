...
def main(
    ...
    no_hover_z: bool = typer.Option(
        False, "--no-hover-z", help="Disable automatic altitude control (Z axis)."
    ),
    no_hover_xy: bool = typer.Option(
        False, "--no-hover-xy", help="Disable automatic position control (X and Y axes)."
    ),
    no_perspective: bool = typer.Option(
        False, "--no-perspective", help="Disable perspective transformation."
    ),
):
    ...
    try:
        env = DroneEnv(
            ...
            hover_z=not no_hover_z,
            hover_xy=not no_hover_xy,
